...
namespace eosio { namespace chain {
  ...
  const std::unique_ptr<wasm_instantiated_module_interface>& get_instantiated_module( const digest_type& code_id, const shared_string& code, const uint8_t& vm_type,
