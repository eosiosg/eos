	...
	DEP_ARRAY=(clang-7 lldb-4.0 libclang-7.0-dev cmake make automake libbz2-dev libssl-dev \
...
mongodconf
	...
	if [ ! -d "${HOME}/opt/wasm/bin" ]; then
		...
		if ! git clone --depth 1 --single-branch --branch release_70 https://github.com/llvm-mirror/clang.git
		then
